...
import { UserProfileDto, UpdateUserProfileDto, UpdateEmailDto, UpdatePasswordDto } from '@/types'; // Adjusted path
...
const UserAccountPage: FC = () => {
    ...
    return (
        <div>
            <h1 className="text-3xl font-semibold text-gray-900 mb-6">Account Info</h1>
                    ...
                    <div className="flex items-center justify-between py-2 border-b border-gray-200">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="bg-blue-600 text-white rounded-full h-16 w-16 flex items-center justify-center text-2xl">
                                {profile.nama_Peminjam ? profile.nama_Peminjam[0].toUpperCase() : 'U'}
                            </div>
                            <button
                    ...
                    <form onSubmit={handleProfileUpdate} className="flex flex-col space-y-4">
                        <div className="flex items-center justify-between py-2 border-b border-gray-200">
                            ...
                            {editMode ? (
                                ...
                                <span className="text-gray-900 w-3/4">{profile.nama_Peminjam}</span>
                            )}
                        </div>
                        ...
                        <div className="flex justify-end pt-4">
                            {editMode ? (
                                <div className="space-x-3">
                                    ...
                                    <button type="button" onClick={() => { setEditMode(false); setName(profile.nama_Peminjam); setPhone(profile.no_Telp || ''); setAddress(profile.alamat || ''); }} className="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300">
                                        Cancel
                                    </button>
                                </div>
                            ) : (
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex items-center justify-between py-2 border-b border-gray-200">
                        <label htmlFor="address-input-contact" className="font-semibold text-gray-700 w-1/4">Address</label>
                        {editMode ? (
                            <textarea
                                id="address-input-contact"
                                className="shadow appearance-none border rounded w-3/4 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500"
                                rows={3}
                                value={address}
                            ...
                            <span className="text-gray-900 w-3/4">{profile.alamat || 'N/A'}</span>
                        )}
                    </div>
                    <div className="flex justify-end pt-4">
                        <button
